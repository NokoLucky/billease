...
import { importBillsFromText, type ParsedBill } from '@/ai/flows/import-bills-flow';
...
export default function ImportPage() {
  ...
  const handleProcessText = async () => {
    ...
    try {
      ...
      console.error(e);
      setError('An unexpected error occurred while parsing your notes. Please try again.');
    } finally {
      setIsLoading(false);
    }
  };
